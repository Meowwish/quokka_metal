...
template <> struct Physics_Traits<TheProblem> {
	...
	static constexpr int numPassiveScalars = 30; // metal scalar plus chemistry/channel scalars
...
template <> void QuokkaSimulation<TheProblem>::createInitialStochasticStellarPopParticles()
{
	...
	const int nreal_extra = quokka::StochasticStellarPopParticleRealComps<TheProblem>;
